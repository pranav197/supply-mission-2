...
function setup() {
	...
	boxSprite=createSprite(300,600,20,100);
	boxSprite.shapeColor=color("red");

	box2Sprite=createSprite(390,650,200,20);
	box2Sprite.shapeColor=color("red");

	box3Sprite=createSprite(480,600,20,100);
...
function keyPressed() {
 if (keyCode === DOWN_ARROW) {
	...
	packageBody.setStatic(packageBody,isStatic=false);
